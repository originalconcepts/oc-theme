		...
		$types = array(
				...
				'fields' => array(
					...
					'shape'   => array(
						...
						'choices' => array(
							...
							'custom'   => __( 'Custom height', 'oc-blocks' ),
						),
						'def'     => 'circle',
						'group'   => 'design',
					),
					'h'       => array(
						'type'  => 'number',
						'label' => __( 'Tile height (px)', 'oc-blocks' ),
						'def'   => 320,
						'min'   => 80,
						'max'   => 900,
						'dev'   => 'd',
						'when'  => array( 'shape' => array( 'custom' ) ),
						'group' => 'design',
					),
					'hm'      => array(
						'type'  => 'number',
					...
					'fit'     => array(
						...
						'hint'    => __( 'Fill crops to the shape; whole shows all of it, with room around where the proportions differ.', 'oc-blocks' ),
						'choices' => array(
							'cover'   => __( 'Fills the shape', 'oc-blocks' ),
							'contain' => __( 'Shows whole', 'oc-blocks' ),
						),
						'def'     => 'cover',
						'group'   => 'design',
					),
					'corners' => array(
						...
						'def'     => 'soft',
						'when'    => array( 'shape' => array( 'square', 'portrait', 'custom' ) ),
						'group'   => 'design',
					),
					'words'   => array(
						'type'    => 'seg',
					...
					'wshadow' => array(
						'type'  => 'toggle',
						'label' => __( 'Shadow under the name on the picture', 'oc-blocks' ),
						'def'   => true,
						'when'  => array( 'words' => array( 'center', 'bottom' ) ),
						'group' => 'design',
					),
					'names'   => array(
						'type'  => 'labels',
			...
			'brands'     => array(
				...
				'fields' => array(
					...
					'tone'      => array(
						'type'    => 'seg',
						'label'   => __( 'Logo colour', 'oc-blocks' ),
						'hint'    => __( 'Grey lifts to full colour when the pointer rests on it.', 'oc-blocks' ),
						'choices' => array(
							'grey'   => __( 'Grey', 'oc-blocks' ),
							'colour' => __( 'Full colour', 'oc-blocks' ),
						),
						'def'     => 'grey',
						'dev'     => 'd',
						'group'   => 'design',
					...
					'mtone'     => array(
						'type'    => 'seg',
						'label'   => __( 'Logo colour', 'oc-blocks' ),
						'hint'    => __( 'A touch screen has no hover, so this is how the logo stays.', 'oc-blocks' ),
						'choices' => array(
							'grey'   => __( 'Grey', 'oc-blocks' ),
							'colour' => __( 'Full colour', 'oc-blocks' ),
						),
					...
					'pad'       => array(
						'type'  => 'range',
						'label' => __( 'Space around the logo', 'oc-blocks' ),
						'def'   => 0,
						'min'   => 0,
						'max'   => 48,
						'step'  => 2,
			...
			'look'       => array(
				...
				'fields' => array(
					...
					'size'   => array(
						'type'  => 'range',
						'label' => __( 'Picture size', 'oc-blocks' ),
						'hint'  => __( 'How much of its column the room picture takes. It is never cropped and never scaled up — smaller just leaves air around it.', 'oc-blocks' ),
						'def'   => 100,
						'min'   => 40,
						'max'   => 100,
						'step'  => 5,
					...
					'msize'  => array(
						'type'  => 'range',
						'label' => __( 'Picture size', 'oc-blocks' ),
						'hint'  => __( 'How wide each room is in the phone strip. Under 100 the next room peeks in.', 'oc-blocks' ),
						'def'   => 88,
						'min'   => 50,
						'max'   => 100,
						'step'  => 2,
