...
class Heat_Admin {
	...
	public function menu(): void {
		add_submenu_page( Admin::PAGE, __( 'Heat maps', 'oc-stats' ), __( 'Heat maps', 'oc-stats' ), Admin::cap(), self::PAGE, array( $this, 'screen' ) );
	}
	...
	public function admin_assets( $hook ): void {
		...
		wp_enqueue_style( 'oc-stats-admin', OC_STATS_URL . 'assets/css/stats-admin.css', array(), OC_STATS_VERSION );
	}
	...
	public function toolbar( $bar ): void {
		...
		$bar->add_node(
			array(
				...
				'meta'  => array( 'title' => __( 'See where people click on this page', 'oc-stats' ) ),
			)
		);
	}
			...
			'window.ocHeatView = ' . wp_json_encode(
				array(
					...
					'i18n'    => array(
						...
						'dead'      => __( 'Dead clicks', 'oc-stats' ),
						'rage'      => __( 'Rage clicks', 'oc-stats' ),
						'attn'      => __( 'Read depth', 'oc-stats' ),
						'everyone'  => __( 'Everyone', 'oc-stats' ),
						'buyers'    => __( 'Visits that bought', 'oc-stats' ),
						'mobile'    => __( 'Mobile', 'oc-stats' ),
						'tablet'    => __( 'Tablet', 'oc-stats' ),
						'desktop'   => __( 'Desktop', 'oc-stats' ),
						'today'     => __( 'Today', 'oc-stats' ),
						'd7'        => __( '7 days', 'oc-stats' ),
						'd30'       => __( '30 days', 'oc-stats' ),
						'd90'       => __( '90 days', 'oc-stats' ),
						'views'     => __( 'views', 'oc-stats' ),
						'ofClicks'  => __( 'of the clicks on this page', 'oc-stats' ),
						'reach'     => __( 'Half the visitors never go below this line', 'oc-stats' ),
						'none'      => __( 'Nothing recorded for this page, device and period yet.', 'oc-stats' ),
						...
						'keyTitle'  => __( 'What the colours mean', 'oc-stats' ),
						'few'       => __( 'A few', 'oc-stats' ),
						'many'      => __( 'A lot', 'oc-stats' ),
						'keyClicks' => __( 'Blue is a few presses, green and yellow more, red the most pressed place on the page. Somewhere with no colour at all is somewhere nobody pressed.', 'oc-stats' ),
						'keyAttn'   => __( 'Blue is a little time, green and yellow more, red where people stayed longest. The dashed line is as far down as half the visitors got.', 'oc-stats' ),
					),
				)
			) . ';',
			'before'
