...
( function () {
	...
	function draw( data ) {
		...
		cust.innerHTML = '<div><span>' + esc( T.newCust ) + '</span><b>' + fmtInt( data.customers[ 0 ] ) + '</b><small>&nbsp;</small></div><div><span>' + esc( T.returning ) + '</span><b>' + fmtInt( data.customers[ 1 ] ) + '</b><small>&nbsp;</small></div>'
			+ ( data.leads ? '<div><span>' + esc( T.leads ) + '</span><b>' + fmtInt( data.leads[ 0 ] ) + '</b><small>&nbsp;</small></div>' : '' );
