...
final class Search_Panel {
	...
	public static function panel_html(): string {
		...
		ob_start();
		?>
		<div id="oc-header-search" class="oc-search" data-oc-search data-mode="<?php echo esc_attr( $mode ); ?>" data-min="<?php echo esc_attr( (string) $min ); ?>" data-action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" hidden>
