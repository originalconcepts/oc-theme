...
final class Admin {
	...
	public function render_widget(): void {
		...
		<div class="ocst-w">
			<?php
			$tile( __( 'Sales', 'oc-theme' ), wp_strip_all_tags( html_entity_decode( wc_price( (float) $cur['gross'], array( 'decimals' => 0 ) ), ENT_QUOTES, 'UTF-8' ) ), Query::change( (float) $cur['gross'], (float) $prev['gross'] ) );
