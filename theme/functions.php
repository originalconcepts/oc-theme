...
define( 'OC_THEME_VERSION', '0.3.269' );
...
require_once OC_THEME_DIR . '/inc/privacy/class-oc-privacy-log.php';
require_once OC_THEME_DIR . '/inc/privacy/class-oc-privacy-front.php';
require_once OC_THEME_DIR . '/inc/privacy/class-oc-privacy-policy.php';
require_once OC_THEME_DIR . '/inc/privacy/class-oc-privacy-admin.php';
...
require_once OC_THEME_DIR . '/inc/feeds/class-oc-feeds-product.php';
...
require_once OC_THEME_DIR . '/inc/class-oc-content-tables.php';
require_once OC_THEME_DIR . '/inc/class-oc-image-fit.php';
require_once OC_THEME_DIR . '/inc/class-oc-product-contact.php';
require_once OC_THEME_DIR . '/inc/class-oc-product-contact-admin.php';
...
require_once OC_THEME_DIR . '/inc/class-oc-checkout-hold.php';
require_once OC_THEME_DIR . '/inc/class-oc-checkout-admin.php';
...
require_once OC_THEME_DIR . '/inc/class-oc-brand-page.php';
require_once OC_THEME_DIR . '/inc/class-oc-blog.php';
require_once OC_THEME_DIR . '/inc/class-oc-guard.php';
require_once OC_THEME_DIR . '/inc/class-oc-guard-admin.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-settings.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-track.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-query.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-rollup.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-insights.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-mail.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-admin.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-product.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-heat.php';
require_once OC_THEME_DIR . '/inc/stats/class-oc-stats-heat-admin.php';
...
( new OC\Theme\Privacy\Log() )->register();
( new OC\Theme\Privacy\Front() )->register();
( new OC\Theme\Privacy\Policy() )->register();
( new OC\Theme\Privacy\Admin() )->register();
( new OC\Theme\Marketing\Third_Party() )->register();
( new OC\Theme\Feeds\Feeds() )->register();
( new OC\Theme\Feeds\Admin() )->register();
( new OC\Theme\Feeds\Product() )->register();
...
( new OC\Theme\Content_Tables() )->register();
( new OC\Theme\Image_Fit() )->register();
( new OC\Theme\Product_Contact() )->register();
...
( new OC\Theme\Dashboard() )->register();
( new OC\Theme\Webp_Run() )->register();
...
( new OC\Theme\Checkout_Hold() )->register();
( new OC\Theme\Checkout_Admin() )->register();
...
( new OC\Theme\Order_Admin() )->register();
( new OC\Theme\Catalog_Front() )->register();
( new OC\Theme\Search_Admin() )->register();
( new OC\Theme\Brands() )->register();
( new OC\Theme\Brand_Page() )->register();
( new OC\Theme\Blog() )->register();
( new OC\Theme\Guard() )->register();
( new OC\Theme\Guard_Admin() )->register();
( new OC\Theme\Stats\Track() )->register();
( new OC\Theme\Stats\Rollup() )->register();
( new OC\Theme\Stats\Admin() )->register();
( new OC\Theme\Stats\Product() )->register();
( new OC\Theme\Stats\Heat() )->register();
( new OC\Theme\Stats\Heat_Admin() )->register();
